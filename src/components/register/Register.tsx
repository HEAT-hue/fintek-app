...
function Register() {
    ...
    const AboutUsOptionList = ["Facebook", "Instagram", "Google search", "Google Playstore"];
            ...
            <div className="authForm-container">
                <form action="GET" className="authForm">
                    ...
                    <div className="form-body">
                        ...
                        <div className="form-field-wrapper">
                            <label htmlFor="ref-text">Referrer Phone or Promo Code (Optional)</label>
                            <input type="text" id="ref-text" placeholder="Referrer Phone or code" />
                        </div>

                        <div className="form-field-wrapper">
                            <label htmlFor="aboutUs">How Did You Hear About Us? (Optional)</label>
                            <select
                                id="aboutUs"
